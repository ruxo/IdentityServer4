...
public static class IdentityServerBuilderExtensionsCore
{
    ...
    public static IIdentityServerBuilder AddCoreServices(this IIdentityServerBuilder builder)
    {
        ...
        builder.Services.AddScoped<IAuthContextParser, AuthContextParser>();
    ...
    internal static void AddDecorator<TService>(this IServiceCollection services)
    {
        ...
        if (registration.ImplementationInstance != null)
        {
            ...
            services.Add(new(typeof(Decorator<TService>), innerType, ServiceLifetime.Transient));
            services.Add(new(type, registration.ImplementationInstance));
        }
        else if (registration.ImplementationFactory != null)
        {
            services.Add(new(typeof(Decorator<TService>), provider =>
            {
        ...
        else
        {
            ...
            services.Add(new(typeof(Decorator<TService>), innerType, ServiceLifetime.Transient));
            services.Add(new(type, type, registration.Lifetime));
        }
    }
}