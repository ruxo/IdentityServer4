...
public class DefaultUserConsentStore : DefaultGrantStore<Consent>, IUserConsentStore
{
    ...
    static string GetConsentKey(string subjectId, string clientId) => $"{clientId}|{subjectId}";
    ...
    public Task StoreUserConsentAsync(Consent consent)
    {
        ...
        return StoreItemAsync(key, consent, consent.ClientId, consent.SubjectId, None, null, consent.CreationTime, consent.Expiration, None);
    }
    ...
    /// <returns></returns>
    public Task<Option<Consent>> GetUserConsentAsync(string subjectId, string clientId) => GetItemAsync(GetConsentKey(subjectId, clientId));
    ...
    /// <param name="clientId">The client identifier.</param>
    /// <returns></returns>
    public Task RemoveUserConsentAsync(string subjectId, string clientId) => RemoveItemAsync(GetConsentKey(subjectId, clientId));
}