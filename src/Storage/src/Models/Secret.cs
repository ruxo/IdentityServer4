...
public sealed class Secret
{
    ...
    public Secret(string value, DateTime? expiration = null) : this(value, null, expiration) { }
    ...
    public override bool Equals(object? obj) =>
        ...
        obj is Secret other && Type.Equals(other.Type, StringComparison.Ordinal) && Value.Equals(other.Value, StringComparison.Ordinal);
}